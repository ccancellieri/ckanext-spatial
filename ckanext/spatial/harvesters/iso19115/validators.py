...
class ISO19115_Schema_MDS(XsdValidator):
    name = 'iso19115-3.2018-mds'
    title = 'ISO19115 XSD Schema for a complete metadata record for any resource. https://schemas.isotc211.org/19115/-3/mds/2.0/'
    ...
    def is_valid(cls, xml):
        ...
        xsd_name = 'Dataset schema 3.2018 (mds.xsd)'
...
class ISO19115_Schema(XsdValidator):
    name = 'iso19115-3.2018-mdb'
    title = 'ISO19115 XSD Schema for a non-services metadata record, manditory fields only. https://schemas.isotc211.org/19115/-3/mdb/2.0/'
...
all_validators = (ISO19115_Schema_MDS,
                  ISO19115_Schema,
                  ISO19115_2_Schema,
                  ISO19115_1_Schema,
                  ISO19115_Schematron)
