...
from ckanext.spatial.harvesters.iso19115.spatial_harvester import ISO19115SpatialHarvester, guess_standard

log = logging.getLogger(__name__)


class ISO19115WAFHarvester(ISO19115SpatialHarvester, SingletonPlugin):
    '''
    A Harvester for WAF (Web Accessible Folders) containing spatial metadata documents.
    e.g. Apache serving a directory of ISO 19115 files.
    '''
    ...
    def info(self):
        return {
            'name': 'iso19115-waf',
            'title': 'iso19115 Web Accessible Folder (WAF)',
            'description': 'A Web Accessible Folder (WAF) displaying a list of spatial metadata documents using the iso19115 schema'
            }
